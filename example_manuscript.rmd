...
Here are some example references in the following sentence. For reviews of this topic see @wickelgren1977speed; @heitz2014speed. Here is another example reference [e.g. @stafford2011pieron][^p]. This paper was produced as part of the 'code club' held in the Department of Psychology at the Univetrsity of Sheffield in 2019, organised by Tom Stafford and Kat Giannadou. 
...
You should install R, RStudio and tex and papaja. More details here https://crsh.github.io/papaja_man/introduction.html#getting-started
...
Rmarkdown is good. Need to change reference style? Change one line. Need to submit as PDF rather than .DOC? Just click 'Word' as output rather than 'PDF' (instructions here https://rmarkdown.rstudio.com/articles_docx.html). Need to change to two column style to make a nice pre-print? Again, simple - just change one line!
